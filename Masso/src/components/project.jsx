    ...
    return (
        ...
        <>
            ...
            <section id="projects" class=" animate-fade-in-up">
               ...
               <h1 className="mb-10 text-3xl text-center font-bold text-white"> Mes <span className="text-[#FE4F6C]">Projets</span></h1>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl font-semibold text-white text-center mt-2">Projet POST-IT</h3>
                        <p class="mb-4 text-[#DCD9D0]">Un projet simple qui marque mes débuts avec Vue.js.
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl text-center text-white font-semibold mt-2">Projet FREEADS</h3>
                        <p class="mb-4 text-[#DCD9D0] ">Projet collaboratif réalisé avec Laravel et Tailwind CSS.
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl text-center text-white font-semibold mt-2">Projet MYSHOP</h3>
                        <p class="mb-4 text-[#DCD9D0]">Projet collaboratif réalisé avec PHP native et Tailwind CSS.
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl text-center text-white font-semibold mt-2">Projet STRAMING</h3>
                        <p class="mb-4  text-[#DCD9D0]">Ce projet marque le début de mon aventure dans le développement web.
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl text-center text-white font-semibold mt-2">Projet MY_ROUTER_TOMATO</h3>
                        <p class="mb-4 text-[#DCD9D0] ">Mon premier projet avec Next.js, utilisant l'API de Moovies pour afficher des films.
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <h3 class="text-xl text-center text-white font-semibold mt-2"> Projet INTEGRATION</h3>
                        <p class="mb-4 text-[#DCD9D0] ">Projet de groupe où nous avons reproduit une maquette à l’identique à l’aide de HTML et CSS.
